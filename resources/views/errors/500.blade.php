...
@section('title', 'Error del servidor - SoftLinkIA')
...
<div class="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 relative overflow-hidden px-4 py-8">
    ...
    <div class="absolute top-1/2 left-10 w-24 h-24 bg-yellow-500/10 rounded-full blur-xl animate-pulse delay-500"></div>
    ...
    <div class="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 text-center">
        ...
        <div class="mb-6 sm:mb-8" data-aos="fade-up" data-aos-delay="200">
            <h1 class="text-6xl sm:text-8xl md:text-9xl lg:text-[12rem] font-bold bg-gradient-to-r from-red-400 via-orange-400 to-red-600 bg-clip-text text-transparent leading-none">
                500
            </h1>
        </div>
        ...
        <div class="mb-6 sm:mb-8" data-aos="fade-up" data-aos-delay="400">
            ...
            <p class="text-base sm:text-lg md:text-xl text-slate-300 mb-4 sm:mb-6 max-w-2xl mx-auto px-4">
                Algo salió mal en nuestros servidores. Nuestro equipo técnico ha sido notificado y está trabajando para solucionarlo.
            </p>
        </div>

        <!-- Illustration -->
        <div class="mb-8 sm:mb-12" data-aos="fade-up" data-aos-delay="600">
            <div class="inline-flex items-center justify-center w-24 h-24 sm:w-32 sm:h-32 bg-gradient-to-r from-red-500/20 to-orange-500/20 rounded-full border border-red-500/30 backdrop-blur-sm">
        ...
        <div class="mt-12 sm:mt-16" data-aos="fade-up" data-aos-delay="1000">
            <div class="bg-slate-800/50 backdrop-blur-sm border border-slate-700/50 rounded-2xl p-4 sm:p-6 max-w-2xl mx-auto">
                ...
                <div class="flex flex-col sm:flex-row gap-2 sm:gap-3 justify-center">
                    ...
                    <a href="mailto:soporte@softlinkia.com" class="text-blue-400 hover:text-blue-300 transition-colors duration-200 flex items-center justify-center gap-1 text-sm sm:text-base">
                        <svg class="w-3 h-3 sm:w-4 sm:h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 4.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"></path>
                        </svg>
                        Soporte Técnico
