<!-- Modal para Eliminar Artículo KIBI -->
<div id="deleteModal"
        ...
        <div class="p-8 text-center">
            <div class="mb-6">
                <p class="text-lg text-gray-700 dark:text-gray-300 mb-2">
                    ¿Estás seguro de que quieres eliminar el artículo KIBI?
                </p>
                <p class="text-sm font-medium text-gray-900 dark:text-white mb-4">
                    "<span id="deleteArticleTitle" class="text-red-600 dark:text-red-400"></span>"
                </p>
                <p class="text-sm text-gray-500 dark:text-gray-400">
                    Todos los datos asociados a este artículo KIBI serán eliminados permanentemente.
                </p>
            </div>
            ...
            <div class="flex items-center justify-center space-x-4">
                ...
                <form id="deleteForm" method="POST" class="inline" onsubmit="submitDeleteForm(event)">
                    ...
                    <button type="submit"
                        ...
                        <span class="relative z-10">Eliminar Artículo KIBI</span>
                    </button>
                </form>
            </div>
        </div>
