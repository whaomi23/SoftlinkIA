    ...
    <div class="relative z-30 flex flex-col justify-center h-full">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 text-center">
                ...
                <div class="mb-6">
                    <div class="flex flex-wrap gap-2 justify-center">
                        ...
                        @foreach($categorias as $categoria)
                            @if(!empty($categoria))
                                @include('KIBI.admin.articulos.components.shared.category-tag', ['categoria' => $categoria, 'size' => 'normal'])
                            @endif
                        @endforeach
                    </div>
                </div>
            ...
            <div class="mb-6 flex justify-center">
                @include('KIBI.admin.articulos.components.shared.difficulty-tag', ['nivel' => $articulo->nivel_dificultad, 'size' => 'normal'])
            </div>
            ...
            @include('KIBI.admin.articulos.components.shared.social-share-mobile', ['articulo' => $articulo])
        </div>
    </div>
</header>
