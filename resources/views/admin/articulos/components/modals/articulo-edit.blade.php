...
<div id="editModal"
    ...
    <div class="relative top-10 mx-auto p-0 border-0 w-11/12 max-w-5xl shadow-2xl rounded-2xl bg-white dark:bg-slate-800 transform transition-all duration-300 ease-in-out scale-95 opacity-0 overflow-hidden"
        ...
        <div class="bg-gradient-to-r from-blue-500 via-purple-500 to-pink-600 p-6 text-white relative">
            ...
            <div class="relative flex items-center justify-between">
                <div class="flex items-center space-x-3">
                    ...
                    <div>
                        <h3 class="text-2xl font-bold">Editar Artículo</h3>
                        <p class="text-blue-100 text-sm">Modifica la información de tu artículo</p>
                    </div>
                </div>
            ...
            <form id="editForm" method="POST" enctype="multipart/form-data" onsubmit="submitEditForm(event)">
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                        ...
                        <div class="lg:col-span-2">
                            <label for="edit_titulo"
                                ...
                                <span
                                    class="material-icons text-base mr-2 text-blue-600 dark:text-blue-400 w-5 h-5 flex items-center justify-center">title</span>
                                <span class="flex-1">Título del Artículo *</span>
                            </label>
                            <div class="relative">
                                <input type="text" id="edit_titulo" name="titulo"
                                    class="w-full px-4 py-3 pl-12 border-2 border-gray-200 dark:border-gray-600 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 dark:bg-slate-700 dark:text-white transition-all duration-200 hover:border-gray-300 dark:hover:border-gray-500"
                        ...
                        <div class="lg:col-span-2">
                            <label for="edit_subtitulo"
                                class="flex items-center text-sm font-semibold text-gray-700 dark:text-gray-300 mb-3 h-6">
                                <span
                                    class="material-icons text-base mr-2 text-blue-600 dark:text-blue-400 w-5 h-5 flex items-center justify-center">subtitles</span>
                        ...
                        <div>
                            <label
                                class="flex items-center text-sm font-semibold text-gray-700 dark:text-gray-300 mb-3 h-6">
                                <span
                                    class="material-icons text-base mr-2 text-blue-600 dark:text-blue-400 w-5 h-5 flex items-center justify-center">category</span>
                            ...
                            <div class="relative">
                                <div id="edit_categoria_dropdown"
                                    class="w-full px-4 py-3 pl-12 border-2 border-gray-200 dark:border-gray-600 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 dark:bg-slate-700 dark:text-white transition-all duration-200 hover:border-gray-300 dark:hover:border-gray-500 cursor-pointer bg-white dark:bg-slate-700 min-h-[52px] flex items-center justify-between">
                        ...
                        <div>
                            <label for="edit_status"
                                class="flex items-center text-sm font-semibold text-gray-700 dark:text-gray-300 mb-3 h-6">
                                <span
                                    class="material-icons text-base mr-2 text-blue-600 dark:text-blue-400 w-5 h-5 flex items-center justify-center">visibility</span>
                                <span class="flex-1">Estado de Publicación *</span>
                            </label>
                            <div class="relative">
                                <select id="edit_status" name="status"
                                    class="w-full px-4 py-3 pl-12 border-2 border-gray-200 dark:border-gray-600 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 dark:bg-slate-700 dark:text-white transition-all duration-200 hover:border-gray-300 dark:hover:border-gray-500 appearance-none cursor-pointer"
                                    required>
                ...
                <div class="mb-8">
                    <div class="flex items-center mb-6">
                        <div class="p-2 bg-pink-100 dark:bg-pink-900/30 rounded-lg mr-3">
                            <span class="material-icons text-pink-600 dark:text-pink-400">image</span>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <input type="file" id="edit_url_imagen" name="url_imagen" accept="image/*"
                                    ...
                                    class="w-full px-4 py-3 pl-12 border-2 border-gray-200 dark:border-gray-600 rounded-xl focus:ring-2 focus:ring-pink-500 focus:border-pink-500 dark:bg-slate-700 dark:text-white transition-all duration-200 hover:border-gray-300 dark:hover:border-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-lg file:border-0 file:text-sm file:font-semibold file:bg-pink-50 file:text-pink-700 hover:file:bg-pink-100">
                                <span
                ...
                <div class="flex items-center justify-between pt-6 border-t border-gray-200 dark:border-gray-700">
                    ...
                    <div class="flex items-center space-x-4">
                        ...
                        <button type="submit"
                            class="px-8 py-3 bg-gradient-to-r from-blue-500 via-purple-500 to-pink-600 text-white font-semibold rounded-xl hover:from-blue-400 hover:via-purple-400 hover:to-pink-500 transition-all duration-300 hover:scale-105 hover:shadow-xl hover:shadow-blue-400/30 transform hover:-translate-y-0.5">
