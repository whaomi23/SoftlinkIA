<div id="contactFormModal" class="fixed inset-0 z-50 hidden">
    ...
    <div class="relative z-10 flex min-h-full items-center justify-center p-4">
        <div class="w-full max-w-4xl max-h-[95vh] rounded-2xl border border-slate-600/50 bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 text-slate-100 shadow-2xl flex flex-col overflow-hidden backdrop-blur-xl">
            ...
            <div class="sticky top-0 z-10 flex items-center justify-between bg-gradient-to-r from-blue-600/20 via-purple-600/20 to-orange-500/20 px-6 py-5 backdrop-blur-md border-b border-slate-600/30">
                ...
                <form id="contactForm" action="{{ route('contact.store') }}" method="POST" novalidate>
                    ...
                    <div data-step="1" class="transition-all duration-300">
                        ...
                        <div class="mt-8 flex justify-end gap-3">
                            ...
                            <button type="button" class="rounded-xl bg-gradient-to-r from-orange-500 to-orange-600 px-6 py-3 font-semibold text-white shadow-lg hover:from-orange-600 hover:to-orange-700 transition-all duration-200 hover:scale-105 hover:shadow-xl" data-next>
                                <span class="flex items-center gap-2">
                                    <span>Próximo</span>
