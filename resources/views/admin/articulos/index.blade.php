...
@section('title', 'Artículos - SoftLinkIA')

@section('content')
    <div class="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
        <!-- Hero Section -->
        @include('admin.articulos.components.admin.admin-hero', ['articulos' => $articulos])
        ...
        <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-12">
            ...
            <!-- Articles Grid -->
            @include('admin.articulos.components.admin.admin-articles-grid', ['articulos' => $articulos])
