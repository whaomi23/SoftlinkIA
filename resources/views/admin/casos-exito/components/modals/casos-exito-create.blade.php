<!-- Modal para Crear Caso de Éxito -->
<div id="createModal"
    ...
    <div class="relative top-8 mx-auto p-0 border-0 w-11/12 max-w-6xl shadow-2xl rounded-3xl bg-white/95 dark:bg-slate-800/95 backdrop-blur-xl transform transition-all duration-500 ease-out scale-90 opacity-0 overflow-hidden border border-white/20 dark:border-slate-700/50"
        ...
        <div class="relative bg-gradient-to-r from-indigo-600 via-blue-600 to-cyan-600 p-8 text-white overflow-hidden">
            <div class="absolute inset-0 bg-gradient-to-r from-indigo-600/90 via-blue-600/90 to-cyan-600/90"></div>
            ...
            <div class="relative flex items-center justify-between">
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        <h3 class="text-3xl font-bold mb-2">Crear Nuevo Caso de Éxito</h3>
                        <p class="text-blue-100 text-base">Completa la información para publicar tu caso de éxito</p>
                    </div>
                </div>
        ...
        <div class="p-10">
            <form id="createForm" action="{{ auth()->user()->isAdmin() ? route('admin.casos-exito.store') : route('creador.casos-exito.store') }}" method="POST"
                        ...
                        <div class="lg:col-span-2">
                            ...
                            <div class="relative group">
                                <input type="text" id="create_titulo" name="titulo"
                                    class="w-full px-6 py-4 pl-14 bg-white/80 dark:bg-slate-700/80 backdrop-blur-sm border-2 border-gray-200/50 dark:border-gray-600/50 rounded-2xl focus:ring-4 focus:ring-cyan-500/20 focus:border-cyan-500 dark:focus:border-cyan-400 dark:text-white transition-all duration-300 hover:border-gray-300 dark:hover:border-gray-500 placeholder-gray-400 dark:placeholder-gray-500"
                                    placeholder="Escribe un título atractivo para tu caso de éxito" required>
                                <span
                                    class="absolute left-5 top-1/2 transform -translate-y-1/2 material-icons text-gray-400 group-focus-within:text-cyan-500 transition-colors">edit</span>
                            </div>
                        </div>
                ...
                <div class="flex items-center justify-between pt-8 border-t border-gray-200/50 dark:border-gray-700/50">
                    ...
                    <div class="flex items-center space-x-4">
                        ...
                        <button type="submit"
                            class="group relative px-8 py-4 bg-gradient-to-r from-indigo-600 via-blue-600 to-cyan-600 text-white font-semibold rounded-2xl hover:from-indigo-500 hover:via-blue-500 hover:to-cyan-500 transition-all duration-300 hover:scale-105 hover:shadow-xl hover:shadow-cyan-500/30 transform hover:-translate-y-1">
                            <div
                            ...
                            <span class="relative z-10">Crear Caso de Éxito</span>
                        </button>
                    </div>
                </div>
            </form>
