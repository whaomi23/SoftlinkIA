<!-- Success Cases Grid -->
<div id="casosExitoGrid" class="relative z-20 grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            @endphp
                ...
                <div class="p-6 flex flex-col flex-grow">
                    ...
                    <div class="flex flex-col gap-3 mb-4 flex-shrink-0">
                        <div class="flex items-center flex-wrap gap-1 min-h-[2rem]">
                            @php
                    ...
                    <div class="flex-shrink-0 mb-4">
                        <h3 class="text-xl font-bold text-white mb-3 line-clamp-2 group-hover:text-cyan-300 transition-colors duration-500 min-h-[3rem]">
                            {{ $casoExito->titulo }}
                        </h3>

                        @if($casoExito->subtitulo)
                            <p class="text-slate-300 group-hover:text-slate-200 line-clamp-2 leading-relaxed transition-colors duration-500 min-h-[3rem]">
                                {{ $casoExito->subtitulo }}
                            </p>
                        @else
                    ...
                    <div class="flex items-center justify-between pt-4 border-t border-slate-700/50 flex-shrink-0">
                        ...
                        <div class="flex space-x-3">
                            <a href="{{ route('creador.casos-exito.show', $casoExito) }}"
                            ...
                            <button onclick="openEditModal({{ $casoExito->id }})"
    ...
    @empty
        <div class="col-span-full">
            <div class="text-center py-20">
                ...
                <h3 class="text-2xl font-bold text-gray-900 dark:text-white mb-3">No tienes casos de éxito aún</h3>
